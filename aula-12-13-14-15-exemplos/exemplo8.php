...
<body>
    <main class="container-fluid">
        ...
        <section>
            <h2>Trabalhando com porcentagem: </h2>
            <?php
            $nome;
            $salarioBase;
            $lucro;
            ...
            $valorFgts = $salarioBase * 0.08;
            $valorPpr = $lucro * 0.006;
            $salarioFinal = $salarioBase - $valorInss - $valorFgts + $valorPpr;

            echo "<p>
            Nome: " . $nome . "<br>
            Salário base: R$ " . $salarioBase . "<br>
            Valor INSS: R$ " . round($valorInss,2) . "<br>
            VAlor FGTS: R$ " . round($valorFgts,2) . "<br>
            Valor PPR: R$ " . round($valorPpr,2) . "<br>
            Salário Final: " . round($salarioFinal,2) . "</p>";
