...
<body>
    <main class="container-fluid">
        ...
        <section>
            <h2>Trabalhando com funções matemáticas: </h2>
            <?php
            $numero;
            ...
            echo "<p>O número " . $numero . ",<br>
            Tem o como seu dobro " . $dobro . ";<br>
            Tem o como seu quadrado " . $quadrado . ";.<br>
            Tem o como sua raiz quadrada " . $raizQuadrada . ";<br>
            E ao somar ele com o PI tem " . round($somaPI,2) . " como resultado final.</p>"
