...
<body>
    <main class="container-fluid">
        ...
        <section>
            ...
            //Entrada de dados - declarando variáveis e atribuindo valores
            ...
            //Processamento de dados - cálculos ou processos de de decisões

            //Saída de dados - mostrando resultados para o usuário
            echo "<p> Nome: " . $nome .
                "<br>Idade: " . $idade .
                "<br>Salário: R$ " . $salario . "</p>";

            //Ou
            /* echo "<p> Nome: $nome 
                    <br>Idade: $idade
                    <br>Salário: $salario </p>"; */
